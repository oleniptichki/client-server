...
class oil_run():
    ...
    def write_input_data(self):
        ...
        output_file.write(str(self.step_rec)+"          ! steps of records on time in files with environmental data (1 step = 5 minutes)\n")
        output_file.write(str(self.risk_nDeltaStep)+"          ! steps on time for writing output files (1 step = 5 minutes)")
        output_file.close()
